...
export interface ApiContactFormRequestContactFormRequest
  extends Schema.CollectionType {
  collectionName: 'contact_form_requests';
  info: {
    singularName: 'contact-form-request';
    pluralName: 'contact-form-requests';
  ...
  attributes: {
    ...
    user_message: Attribute.RichText &
      Attribute.Required &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: false;
    ...
    createdBy: Attribute.Relation<
      'api::contact-form-request.contact-form-request',
      'oneToOne',
      'admin::user'
    > &
      Attribute.Private;
...
export interface ApiFooterFooter extends Schema.SingleType {
  ...
  attributes: {
    ...
    office_contact: Attribute.Component<'footer.contact', true> &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    footer_bg: Attribute.Media &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: false;
        };
...
export interface ApiOurServiceOurService extends Schema.CollectionType {
  ...
  attributes: {
    ...
    preview_text: Attribute.RichText &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiProjectProject extends Schema.CollectionType {
  ...
  attributes: {
    ...
    sort: Attribute.Integer &
      ...
      Attribute.DefaultTo<100>;
    project_facts_heading: Attribute.Component<'section.heading'> &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    project_facts_list: Attribute.DynamicZone<['section.facts']> &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
declare module '@strapi/types' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::contact-form-request.contact-form-request': ApiContactFormRequestContactFormRequest;
